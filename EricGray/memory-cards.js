var MemoryCards = (function() {
	...
	{name:'joker', role:'villain', universe:'dc'}, {name: 'lexluthor', role: 'villain', universe: 'dc'}, 
	{name: 'wolverine', role: 'hero', universe: 'marvel'}, {name: 'hulk', role: 'hero', universe: 'marvel'},
	{name: 'sabretooth', role: 'villain', universe: 'marvel'}, {name: 'generalross', role: 'villain', universe: 'marvel'}]
